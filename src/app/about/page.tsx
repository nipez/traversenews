      ...
      <article className="about-page">
        ...
        <div className="about-body">
          ...
          <p>
            ...
            site. The original story when we have one. Everyone else’s headline
            when they have one. The night out. The civic calendar. The alert
          ...
          <p>
            <strong>Today</strong> is the paper. A traverse.news original leads
            when we have published one. Under that, Around the bay is other
            desks — Record-Eagle, the Ticker, IPR, 9&amp;10, Northern Express,
            and local orgs — as headlines that link out. We do not reprint their
            stories.
          </p>
          <p>
            <strong>Events</strong> is concerts, markets, library programs, and
            nights out. <strong>Civic Calendar</strong> is boards and government
            only. We pull from public listings. If a source does not print a
            time, we leave the time blank. We do not invent noon, “tomorrow,” or
            a show that is not on the calendar.
          </p>
          <p>
            <strong>Alerts</strong> is breaking and official: Grand Traverse 911
            and the Ticker’s Facebook when the post is a crash, outage, closure,
            or warning. It is not a Facebook dump and it is not Overheard.
          </p>
          <p>
          ...
          <p>
            ...
            Nick Perez. Drafts can be built from real public sources. They stay
            in the Desk until they are published. We do not invent people,
            quotes, crashes, or “organizers say” lines. If we use a sentence
            that appeared in another outlet, we say so and we link it.
          </p>
          <p>
          ...
          <p>
            We will not empty Overheard in TC onto the homepage. That group is a
            tip wire. Complaint pile-ons, doxxing, and unverified accusations
