...
const sources: Source[] = [
  ...
  },
  {
    ...
    feed_url: "https://upnorthlive.com/",
    pull_method: "html",
    beat_id: "beat_general",
    enabled: true,
    notes:
      "TV newsroom WPBN/WGTU (7&4). No public RSS — Traverse News pulls on the box. Cap on Around the bay so this wire does not eat the bay.",
  },
  {
    id: "src_leelanau_ent",
    ...
    beat_id: "beat_general",
    enabled: true,
    notes: "No reliable public RSS — Traverse News pulls on the box.",
  },
  {
    id: "src_omp_gazette",
  ...
  },
  {
    ...
    feed_url: "https://www.recordpatriot.com/",
    pull_method: "html",
    beat_id: "beat_general",
    enabled: true,
    notes: "No usable public RSS — Traverse News pulls on the box.",
  },
  {
    id: "src_antrim_review",
    name: "Antrim Review",
    homepage: "https://www.antrimreview.net/",
    feed_url: "https://www.antrimreview.net/rss.xml",
    pull_method: "rss",
    beat_id: "beat_general",
    enabled: true,
    notes:
