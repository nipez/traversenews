...
/**
 * Staff-only unpublished originals. Never published from seed — Desk must
 * publish explicitly. Kept out of createSeedData() so the public site stays empty.
 */
export const STAFF_UNPUBLISHED_DRAFTS: OriginalDraft[] = [
  {
    ...
    body: [
      ...
      "A friends-hosted memorial is 5–9 p.m. Wednesday, Aug. 26, at Open Space Park, open to all, the funeral home says. Visitation is 2–4 p.m. and 6–8 p.m. Thursday, Aug. 27, at Reynolds-Jonkhoff, 305 Sixth St. The funeral is 11 a.m. Friday, Aug. 28, at Trinity Lutheran Church, with church visitation at 10 a.m. and a luncheon at the funeral home at 12:30 p.m. Donations toward funeral expenses: 231-947-6347, 9 a.m.–5 p.m. weekdays.",
    ].join("\n\n"),
    ...
    // 2026-08-22 10:00 America/Detroit (EDT)
